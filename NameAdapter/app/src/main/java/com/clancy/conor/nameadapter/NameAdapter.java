package com.clancy.conor.nameadapter;
...
public class NameAdapter extends RecyclerView.Adapter<NameAdapter.NameViewHolder>{
    ...
    public NameViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.name_view,
                parent, false);
    ...
    class NameViewHolder extends RecyclerView.ViewHolder{
        ...
        public NameViewHolder(@NonNull View itemView) {
            ...
            // note we direct Android Studio to look in itemview not findview
